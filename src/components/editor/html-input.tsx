...
export function HtmlInput({ value, onChange, error, className }: HtmlInputProps) {
      ...
      <ScrollArea className="flex-1">
        <div className="flex h-full">
          ...
          <Textarea
            ...
            spellCheck={false}
            className={cn(
              'flex-1 resize-none border-0 bg-transparent py-4 pr-4 font-mono text-sm outline-none focus-visible:ring-0 leading-6 placeholder:text-slate-300 dark:placeholder:text-slate-600',
